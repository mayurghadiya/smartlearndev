...
$content = erLhcoreClassModelChatOnlineUser::executeRequest('https://##livehelperchat/archive/master.zip');
...
if ($zip->open('var/tmpfiles/master.zip') === true) {
	...
	$jsonObject = json_decode(erLhcoreClassModelChatOnlineUser::executeRequest('https://##livehelperchat/master/lhc_web/doc/update_db/structure.json'),true);
