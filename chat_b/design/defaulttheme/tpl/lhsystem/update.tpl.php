...
<div class="row">
	<div class="col-md-4">
		...
		<a class="btn btn-default btn-xs" href="http://#/news-5c.html" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','News')?></a>
		<a class="btn btn-default btn-xs" href="http://#/article/view/63" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','Update instructions')?></a>
