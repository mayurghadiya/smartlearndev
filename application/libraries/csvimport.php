...
class Csvimport {
   ...
   /**
     ...
     * @param   detect_line_endings  boolean  When true sets the php INI system_setting to allow script to detect line endings. Needed for CSV files created on Macs.
     * @return  array
     */
