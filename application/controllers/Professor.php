...
//$exam = $this->Professor_model->exam_details();
    ...
    function email_inbox() {
        ...
        $data['inbox'] = professor_inbox();
        $data['title'] = 'Inbox';
        $data['content'] = 'backend/professor/email_inbox';
        //$data['page_name'] = 
    ...
    function email_compose() {
        ...
        $data['course'] = $this->Professor_model->get_all_course();
        $data['degree'] = $this->Professor_model->get_all_degree();
    ...
    function attendance() {
        ...
        if ($_POST) {
            ...
            $data['class_name'] = $_POST['class'];
            $data['professor'] = $this->session->userdata('login_user_id');
            $data['date'] = $_POST['date'];
            $data['class_routine'] = $_POST['class_routine'];
            $student = $this->Crud_model->student_list_by_department_course_batch_semester_class($data['department'], $data['branch'], $data['batch'], $data['semester'], $data['class_name']);
