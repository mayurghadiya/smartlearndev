...
// payment nikita 
    ...
    function vocationalcourse($param1 = '', $param2 = '')
    {
        ...
        else
        {
          ...
          $page_data['vocationalcourse']=$this->db->query('SELECT * FROM vocational_course where course_startdate >"'.date('Y-m-d', strtotime("+2 days")).'"
                   and NOT EXISTS (SELECT vocational_course_id FROM vocational_course_fee
