...
$config['custom_plugin']= $config['base_url']."/assets/plugins/";
...
$config['json_path']= $config['base_url']."/data/";
...
|
*/
$config['encryption_key'] = 'M68337efvEeginC3R5SJifHQy4dFY1rp';
...
|
| Other session cookie system_setting are shared with the rest of the application,
...
|
| Note: These system_setting (with the exception of 'cookie_prefix' and
