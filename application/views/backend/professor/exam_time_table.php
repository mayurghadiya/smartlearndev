                                                ...
                                                foreach ($time_table as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="menu-action">
                                                            ...
                                                            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?professor/exam_time_table/delete/<?php echo $row->exam_time_table_id; ?>');" data-original-title="remove" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red"><i class="fa fa-times"></i> </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $counter++;
        ...
        $().ready(function () {
            ...
            $('#search-exam-data').on('click', function () {
                ...
                if (form.valid() == true)
                {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>index.php?professor/get_exam_schedule_filter/' + degree + '/'
    ...
    <script>
        $(document).ready(function () {
            ...
            function get_exam_list(degree_id, course_id, batch_id, semester_id) {
                ...
                $('#search-exam').append('<option value="">Select</option>');
                $.ajax({
                    url: '<?php echo base_url(); ?>index.php?professor/get_exam_list/' + degree_id + '/' + course_id + '/' + batch_id + '/' + semester_id,
                    type: 'get',
                    success: function (content) {
