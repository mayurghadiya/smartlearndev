                    ...
                    <div class="container ">
                        <div class="vd_top-nav vd_nav-width  ">
                            <div class="vd_panel-header">
                                <div class="logo">
                                    <a href="<?php echo base_url('index.php?professor/dashboard'); ?>"><img alt="logo" src="<?php echo base_url(); ?>assets/img/logo.png"></a>
                                </div>
                                <!-- logo -->
                                                ...
                                                <li id="top-menu-profile" class="profile mega-li"> 
                                                    <a href="#" class="mega-link"  data-action="click-trigger"> 
                                                        <span  class="mega-image">
                                                            <img width="45" height="35" src="<?php //echo $this->crud_model->get_image_url('professor', $this->session->userdata('admin_id')); ?>" alt="...">             
                                                        </span>
                    ...
                    <div class="vd_navbar vd_nav-width vd_navbar-email vd_bg-black-80 vd_navbar-left vd_navbar-style-2 ">
                        ...
                        <div class="navbar-menu clearfix">
                            <h3 class="menu-title hide-nav-medium hide-nav-small">
                                <a href="<?php echo base_url(); ?>index.php?professor/email_compose" class="btn vd_btn vd_bg-red">
                            ...
                            <div class="vd_menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('index.php?professor/email_inbox'); ?>">
                                            <span class="menu-icon entypo-icon"><i class="icon-mail"></i></span> 
                                            <span class="menu-text">Inbox</span>  
                                        </a> 
                                    </li> 
                                    <!--                                    <li>
                                                                            <a href="<?php echo base_url('index.php?professor/email_draft'); ?>">
                                                                                <span class="menu-icon"><i class="fa fa-archive"></i></span> 
                                                                                <span class="menu-text">Drafts</span>            
                                                                            </a>
                                                                        </li>          -->
                                    <li>
                                        <a href="<?php echo base_url(); ?>index.php?professor/email_sent">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>index.php?professor/dashboard">
