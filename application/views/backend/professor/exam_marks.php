        ...
        <div class="vd_content clearfix">
            ...
            <script>
                function get_exam_list(degree_id, course_id, batch_id, semester_id, exam_id) {
                    $.ajax({
                        url: '<?php echo base_url(); ?>index.php?professor/get_exam_list/' + degree_id + '/' + course_id + '/' + batch_id + '/' + semester_id + '/' + exam_id,
                        type: 'get',
                ...
                $(document).ready(function () {
                    ...
                    $('#exam').on('change', function () {
                        ...
                        if (degree_id && course_id && batch_id && semester_id && exam_id)
                            location.href = '<?php echo base_url(); ?>index.php?professor/marks/' + degree_id + '/' + course_id + '/' + batch_id + '/' + semester_id + '/' + exam_id
                    })
                })
            </script>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    if (degree_id && course_id && batch_id && semester_id && exam_id) {
                        ...
                        $('select#semester').append('<option value="">Select</option>');
                        $.ajax({
                            url: '<?php echo base_url(); ?>index.php?professor/get_semesters_of_branch/' + course_id,
                            type: 'get',
                            success: function (content) {
                                var semester = jQuery.parseJSON(content);
                                console.log('hello');
                        ...
                        $('#student').on('change', function () {
                            ...
                            if (student_id != '') {
                                location.href = '<?php echo base_url(); ?>index.php?professor/marks/' + degree + '/'
