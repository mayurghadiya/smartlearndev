                                ...
                                <div class="child-menu">
                                    <div class="content-list content-menu">
                                        <ul class="list-wrapper pd-lr-10">
                                            <li> 
                                                <a href="<?php echo base_url(); ?>index.php?professor/email_reply/<?php echo $email->email_id; ?>"> 
                                                    <div class="menu-icon">
                                                        <i class=" fa fa-reply"></i>
                                                    </div> <div class="menu-text">Reply</div> 
                                                </a> 
                                            </li>
                                            <li> 
                                                <a href="<?php echo base_url('index.php?professor/email_compose'); ?>"> 
                                                    <div class="menu-icon">
