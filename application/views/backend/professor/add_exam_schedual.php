            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo ucwords("Add Exam Schedual");?>
                    </div>
                </div>
...
<div class="box-content">  
                                    ...
                                    <?php echo form_open(base_url() . 'index.php?professor/exam_time_table/create', array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'exam_time_table_form', 'target' => '_top')); ?>
                                    <br/>
                                    <div class="padded">
                                        <?php
