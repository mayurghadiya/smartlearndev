...
<?php echo form_open(base_url() . 'index.php?professor/assignment/create', array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmassignment', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
<div class="padded">
...
<script type="text/javascript">
    $("#btnadd").click(function (event) {
        ...
        {   
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() . 'index.php?professor/checkassignments'; ?>",
                dataType: 'json',
                async: false,
                data:
                        {
