...
<div class="vd_content-wrapper">
    ...
    <div class="vd_banner vd_bg-white clearfix pd-20">
        <div class="panel widget light-widget">
           <?php echo form_open(base_url() . 'index.php?register/register/create' , array('class' => 'form-horizontal form-groups-bordered validate','role'=>'form','id'=>'frmstudent','target'=>'_top','enctype' => 'multipart/form-data'));?>
                <div  class="panel-body">
                    <!--<h2 class="mgbt-xs-20"> Registraion: <span class="font-semibold"></span></h2>-->
                    <br/>
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="form-img text-center mgbt-xs-15"> 
										<img src="<?=$this->config->item('image_path')?>photos/05.jpg" id="manage_profile"  alt="...">
										<input id="upload"  name="userfile" type="file"  accept="image/*"/><br/>
										<a href="" id="upload_link" class="btn vd_btn  vd_bg-blue" style="margin-top:15px;"><i class="fa fa-cloud-upload append-icon"></i>Upload</a> </div>
                                    <br/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-9">                        
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text" name="email_id" value="" placeholder="email@yourcompany.com">
                                        </div>
                                        <!-- col-xs-12 -->
                                    </div>
                                    <!-- row --> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text" value="" name="f_name" placeholder="first name">
                                        </div>
                                    </div>
                                    <!-- row --> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text" id="datepicker-normal" name="birthdate" value="" />
                                        </div>
                                    </div>
                                    <!-- row --> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
											<select style="width:100%;" class="form-control" name="degree" id="user_type">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <textarea rows="3" name="std_about"></textarea>
                                        </div>
                                    </div>
                                    <!-- row --> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text" name="mobileno" value="" placeholder="mobile phone">
                                        </div>
                                    </div>
                                    <!-- row --> 
                                </div>
							...
							<script type="text/javascript" src="<?= $this->config->item('js_path') ?>countries.js"></script>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text"  value="" name="facebook" placeholder="facebook">
                                        </div>
                                        <!-- col-xs-9 -->
                                    </div>
                                    <!-- row --> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 controls">
                                    <div class="row mgbt-xs-0">
                                        <div class="col-xs-9">
                                            <input type="text" value="" name="twitter" placeholder="twitter">
                                        </div>
                                        <!-- col-xs-9 -->
                                    </div>
                                    <!-- row --> 
