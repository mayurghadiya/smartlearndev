...
<div id="front-1-banner" class="vd_banner vd_bg-white clearfix slide-waypoint" data-waypoint="home" >
		<div id="layerslider" style="width:100%;height:500px;">
			<div class="ls-slide" data-ls="slidedelay:7500;transition2d:8;">
                <img src="<?=$this->config->item('image_path')?>banner/fw-1.jpg" class="ls-bg" alt="Slide background"/>
                <p class="ls-l font-sm" style="top:80px; left:190px;"  data-ls="offsetyin:-100; offsetxin:0;">introducing...</p>
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-1-logo--only.png" class="ls-l" style="top:130px; left:110px;" data-ls="delayin: 1200;easingin:easeOutQuart; offsetyin:-0; offsetxin:0; rotateyin:-60;" />
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-1-logo-word.png" class="ls-l" style="top:320px; left:110px;" data-ls="delayin: 1600;easingin:easeOutQuint; offsetyin:100; offsetxin:0;" />  
                ...
                <a href="index.html" class="ls-l"  style="top:220px;left:1000px;" data-ls="durationin:1500;delayin:5000;rotatein:20;rotatexin:30;scalexin:1.5;scaleyin:1.5;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;">  
				<img alt="example image" src="<?=$this->config->item('image_path')?>banner/take-quick-tour-image.png"  >
                </a>
 <!--               	<span class="font-sm vd_black mgbt-xs-5">Take a quick tour..</span><br/>
                	<a class="btn vd_btn btn-lg vd_bg-green" href="index.html">
						LIVE PREVIEW <i class="fa fa-angle-double-right prepend-icon"></i>
                    </a>
				</p>    -->             
                               
				<img alt="example image" class="ls-l ls-linkto-3" style="top:410px;left:200px;white-space: nowrap;" data-ls="offsetxin:-50;delayin:5000;offsetxout:-50;" src="<?=$this->config->item('image_path')?>banner/left.png" ><img alt="example image" class="ls-l ls-linkto-2" style="top:410px;left:250px;white-space: nowrap;" data-ls="offsetxin:50;delayin:5000;offsetxout:50;" src="<?=$this->config->item('image_path')?>banner/right.png" >           
			...
			<div class="ls-slide" data-ls="transition2d:8; slidedelay:9000;">
                <img src="<?=$this->config->item('image_path')?>banner/fw-1.jpg" class="ls-bg" alt="Slide background"/>            
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-center-macbook.png" class="ls-l" style="top:165px; left:670px;" data-ls="delayin: 5600;easingin:easeOutQuart; offsetyin:-50; offsetxin:0; durationin:2000;" />             
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-center-desktop.png" class="ls-l" style="top:40px; left:425px;" data-ls="delayin: 200;easingin:easeOutQuart; offsetyin:-200; offsetxin:0; durationin:2000;" />
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-right-desktop.png" class="ls-l" style="top:40px; left:800px;" data-ls="delayin: 800;easingin:easeOutQuart; offsetyin:-0; offsetxin:0; rotateyin:-90; durationin:2000; showuntil:1200; offsetyout:210; offsetxout:360; durationout:620; easingout:linear; scaleyout:1.5; scalexout:1.5;" />       
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-left-desktop.png" class="ls-l" style="top:40px; left:50px;" data-ls="delayin: 800; easingin:easeOutQuart; offsetyin:-0; offsetxin:0; rotateyin:90; durationin:2000; showuntil:1200; offsetyout:210; offsetxout:-400; durationout:600; easingout:linear; scaleyout:1.5; scalexout:1.5;" />                 
                ...
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-right-desktop-big.png" class="ls-l" style="top:150px; left:1100px;" data-ls="delayin: 4000;easingin:easeOutQuart; offsetyin:-220; offsetxin:-450;  durationin:2000; scalexin:.5; scaleyin:.5;" /> 
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-left-desktop-big.png" class="ls-l" style="top:150px; left:-500px;" data-ls="delayin: 4000;easingin:easeOutQuart; offsetyin:-220; offsetxin:450;  durationin:2000; scalexin:.5; scaleyin:.5;" />   
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-center-tab.png" class="ls-l" style="top:185px; left:345px;" data-ls="delayin: 5800;easingin:easeOutQuart; offsetyin:-50; offsetxin:0; durationin:2000;" />  
                <img alt="example image" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-2-logo-center-phone.png" class="ls-l" style="top:262px; left:460px;" data-ls="delayin: 6000;easingin:easeOutQuart; offsetyin:-50; offsetxin:0; durationin:2000;" /> 
				<img alt="example image" class="ls-l ls-linkto-1" style="top:40px;left:600px;white-space: nowrap;" data-ls="offsetxin:-50;delayin:6500;offsetxout:-50;" src="<?=$this->config->item('image_path')?>banner/left.png" ><img alt="example image" class="ls-l ls-linkto-3" style="top:40px;left:650px;white-space: nowrap;" data-ls="offsetxin:50;delayin:6500;offsetxout:50;" src="<?=$this->config->item('image_path')?>banner/right.png">                 
            
			</div>

			<div class="ls-slide" data-ls="transition2d:8; slidedelay:9000;">
				<img src="<?=$this->config->item('image_path')?>banner/fw-1.jpg" class="ls-bg" alt="Slide background"/>
                <img alt="example image" class="ls-l" style="top:50px;left:500px;white-space: nowrap;" data-ls="offsetxin:0; offsetyin: 100; durationin:1500; delayin:800; offsetxout:-300;parallaxlevel:-10;" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-3-desktop-1.png">
                <img alt="example image" class="ls-l" style="top:130px;left:600px;white-space: nowrap;" data-ls="offsetxin:0; offsetyin: 100; durationin:1500; delayin:1300; offsetxout:-300;parallaxlevel:1;" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-3-desktop-2.png">   
                <img alt="example image" class="ls-l" style="top:220px;left:700px;white-space: nowrap;" data-ls="offsetxin:0; offsetyin: 100; durationin:1500; delayin:1800; offsetxout:-300;parallaxlevel:10;" src="<?=$this->config->item('image_path')?>banner/banner-front-2-page-3-desktop-3.png">                                
				...
				<a class="ls-l btn vd_btn btn-lg vd_bg-red" style="top:320px;left:90px; font-weight:300; white-space: nowrap;" data-ls="offsetxin:0;durationin:2000;delayin:5200;easingin:easeOutCubic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;" href="#">
					Cleik Here
				</a>               
				<img alt="example image" class="ls-l ls-linkto-2" style="top:410px;left:100px;white-space: nowrap;" data-ls="offsetxin:-50;delayin:5200;offsetxout:-50;" src="<?=$this->config->item('image_path')?>banner/left.png" ><img alt="example image" class="ls-l ls-linkto-1" style="top:410px;left:150px;white-space: nowrap;" data-ls="offsetxin:50;delayin:5200;offsetxout:50;" src="<?=$this->config->item('image_path')?>banner/right.png" >
			</div>            
    ...
    <div class="vd_content clearfix">
      <div class="row">
        <div class="col-md-12 text-center">
			<h1 class="font-lg">Features of <span class="font-semibold vd_green">Smart learn Theme</span></h1>
    ...
    <div class="vd_content clearfix">
      <div class="row">
        <div class="col-md-5 mgbt-xs-20">
          ...
          <br/>
          <p><a class="btn vd_btn vd_btn-bevel vd_bg-green btn-lg" href="#">Click Here</a> <br/></p>
        </div>
      ...
      <div class="row">
        <div class="col-md-5 mgbt-xs-20">
          <div class="text-center"> <img alt="example image" src="<?=$this->config->item('image_path')?>banner/responsive-device.png" /> </div>
        </div>
        <div class="col-md-7">
      ...
      <div class="row">
        <div class="col-md-12 text-center mgbt-xs-20">
          ...
          <h2 class="font-semibold"> Smart learn Screen Shot </h2><br/>
        </div>
        <div class="vd_gallery">
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-1"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-01.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-01-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Stunning</span> Dashboard</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-01.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-2"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-02.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-02-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">A Lot of</span> premade Pages</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-02.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-3"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-03.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-03-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Dashboard </span>Examples</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>/screenshot/vendroid-03.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-4"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-04.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-04-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">A lot of Skin and Functionality</span> to Choose</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-04.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-5"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-05.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-05-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Neat </span> Invoice</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-05.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-6"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-06.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-06-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Email</span> Ready Page</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>/screenshot/vendroid-06.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-7"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-07.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-07-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Website Layout Tour Guide</span> Ready Examples</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/Smart learn-07.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-8"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-08.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-08-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">Registration, Login, Error</span> and many example form</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-08.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 mgbt-xs-15">
            <div class="gallery-item full-width gallery-9"> <a href="<?=$this->config->item('image_path')?>screenshot/vendroid-09.jpg"> <img alt="example image" src="<?=$this->config->item('image_path')?>screenshot/vendroid-09-thumbs.jpg" />
              <div class="bg-cover"></div>
              </a>
              <div class="vd_info">
                <h3 class="mgbt-xs-15"><span class="font-semibold">User Profile</span> Page</h3>
                <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="<?=$this->config->item('image_path')?>screenshot/vendroid-09.jpg"  data-rel="prettyPhoto[1]"><i class="fa fa-search"></i></a> <a class="vd_bg-green vd_white mgr-10 btn vd_round-btn btn-xs" role="button" href="#"><i class="fa fa-link"></i></a> </div>
            </div>
          </div>
        </div>
        <!-- vd_gallery -->
    				...
    				<div class="vd_carousel">
                        <div class="vd_carousel-column">                  
                            <div class="content-list content-large">
                              <div class="menu-icon"> <img alt="example image" class="img-circle" src="<?=$this->config->item('image_path')?>avatar/avatar.jpg" /> </div>
                              <div class="menu-text"> <br/>
                                <br/>
                                <h4 class="vd_black font-semibold mgbt-xs-0"><strong>Angela Deborah</strong></h4>
                                <p class="vd_black font-semibold">CEO of Smart learn, Inc.</p>
                              </div>
                            </div>
                        ...
                        <div class="vd_carousel-column">                  
                            <div class="content-list  content-large">
                              <div class="menu-icon"> <img alt="example image" class="img-circle" src="<?=$this->config->item('image_path')?>avatar/avatar-2.jpg" /> </div>
                              <div class="menu-text"> <br/>
                                <br/>
                        ...
                        <div class="vd_carousel-column">                  
                            <div class="content-list content-large">
                              <div class="menu-icon"> <img alt="example image" class="img-circle" src="<?=$this->config->item('image_path')?>avatar/avatar-3.jpg" /> </div>
                              <div class="menu-text"> <br/>
                                <br/>
                        ...
                        <div class="vd_carousel-column">                  
                            <div class="content-list content-large">
                              <div class="menu-icon"> <img alt="example image" class="img-circle" src="<?=$this->config->item('image_path')?>avatar/avatar-4.jpg" /> </div>
                              <div class="menu-text"> <br/>
                                <br/>
    ...
    <div class="vd_content clearfix">
      <div class="row">
        <div class="col-md-12">
          ...
          <br/>
          <br/>
          <div class="text-center"> <a class="btn vd_btn vd_btn-bevel vd_bg-red btn-lg font-semibold" href="#">Click Here</a> </div>
          <br/>
          <br/>
        ...
        <div class="col-md-offset-3 col-sm-offset-2 col-md-6 col-sm-8">
          <div class="panel">
            ...
            <form role="form" action="#" id="contact-form-widget" class="form-horizontal">
                <input type="hidden" id="admin-email" name="admin-email" value="info@email.com">
                <input type="hidden" id="admin-name" name="admin-name" value="Smart Learn, Inc.">            
                <div class="row">
              ...
              <div class=" col-xs-12">
                ...
                <div class="copyright text-center">
                    ...
                    P: (123) 456-7890 
                  	...
                  	Copyright &copy;2016 Smart  Learn Inc. All Rights Reserved 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
