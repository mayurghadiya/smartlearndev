	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/cms/do_update/'.$row['c_id'] , array('class' => 'form-horizontal form-groups-bordered validate','id'=>'cmspage','target'=>'_top'));?>
                    <div class="padded">
                            <div class="row">
                            ...
                            <div class="form-group form-actions">
                                ...
                                <div class="col-sm-10">
                                    <button type="button" class="btn vd_btn vd_bg-green vd_white submit"><i class="icon-ok"></i> Edit</button>
                                </div>
                            </div>
        		</form>
            </div> </div> </div>
