        ...
        <div class="panel-body">
                <div class="tab-pane box" id="add" style="padding: 5px">
                    ...
                    <span style="color:red">* <?php echo "is ".ucwords("mandatory field");?></span> 
                                ...
                                <?php echo form_open(base_url() . 'forum/topicscrud/update/'.$param2, array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmadmission_type', 'target' => '_top')); ?>
                                    <div class="padded">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <select name="topic_status">
                                                    <option value="1" <?php if($row['forum_topic_status']=="1"){ echo "selected=selected"; } ?>>Active</option>
                                                    <option value="0"  <?php if($row['forum_topic_status']=="0"){ echo "selected=selected"; } ?>>Inactive</option>		
                                                </select>	
