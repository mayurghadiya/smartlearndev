			...
			<div class="vd_head-section clearfix">
				<div class="vd_panel-header">
					<ul class="breadcrumb">
						...
						<li class="active">Admission Type Managment</li>
					</ul>
							...
							<div class="tab-pane box active" id="list">
								...
								<div class="panel-body table-responsive">
									<table class="table table-striped" id="data-tables">
										...
										<tbody>
											<?php $count = 1;foreach($admission_type as $row): ?>
											<tr>
												...
												<td class="menu-action">
													...
													<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/admission_type/delete/<?php echo $row['at_id'];?>');" data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red"><i class="fa fa-times"></i> </a>
												</td>
											</tr>
											<?php endforeach;?>						
										</tbody>
									...
									<div class="padded">
										...
										<div class="form-group">
											<div class="col-sm-offset-3 col-sm-5">
												<button type="submit" class="btn btn-info">Add Admission Type</button>
											</div>
										</div>
									</form>               
								</div>                
