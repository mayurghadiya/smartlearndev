...
<script>
    ...
    <ul class="nav nav-tabs bordered nav-fixedtabs" >
                                ...
                                <li class="nav-fixed-tabs" >
                                    <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/addevent/');" id="navfixed" class="nav-fixed-a-tabs vd_bg-red" data-toggle="tab"><i class="entypo-plus-circled"></i>
