            ...
            <div class="vd_head-section clearfix">
                <div class="vd_panel-header">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url('index.php?student/email_inbox'); ?>">Email</a></li>
                                ...
                                <div class="child-menu">
                                    <div class="content-list content-menu">
                                        <ul class="list-wrapper pd-lr-10">
                                            <li> 
                                                <a href="<?php echo base_url(); ?>index.php?student/email_reply/<?php echo $email->email_id; ?>"> 
                                                    <div class="menu-icon">
                                                        <i class=" fa fa-envelope"></i>
                                                    </div> 
                                                    <div class="menu-text">Reply</div> 
                                                </a> 
                                            </li>
