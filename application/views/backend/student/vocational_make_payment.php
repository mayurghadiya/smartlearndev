                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form id="process_payment" class="form-horizontal form-groups-bordered validate" role="form" method="post" action="<?php echo base_url('index.php?student/vocational_authorize_net_make_payment'); ?>">
