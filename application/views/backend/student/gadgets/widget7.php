            ...
            <div class="col-sm-6 ui-sortable">
                <div class="content-list content-menu">
                    <ul class="list-wrapper pd-lr-10">
                        ...
                        <li><a href="<?php echo base_url(); ?>index.php?student/project/submission" target="_blank"> <div class="menu-icon"><i class=" fa fa-envelope"></i></div> <div class="menu-text">Project List</div> </a> </li>
