                ...
                <div class="content-list content-menu">
                    <ul class="list-wrapper pd-lr-10">
                     <li><a href="<?php echo base_url(); ?>index.php?student/assignment" target="_blank"> <div class="menu-icon"><i class=" icon-lock"></i></div> <div class="menu-text">Assignments List
                       ...
                       <!--     <li> <a href="<?php echo base_url(); ?>index.php?student/assignment" target="_blank"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Submitted Assignment List</div> </a> </li>
