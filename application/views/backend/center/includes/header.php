                                    ...
                                    <div class="vd_mega-menu pull-right">
                                        <ul class="mega-ul">
                                            ...
                                            <li id="top-menu-profile" class="profile mega-li"> 
                                                <?php if ($this->session->userdata('centeruser_login') == 1) { ?>
                                                        ...
                                                        <div class="child-menu"> 
                                                            <div class="content-list content-menu">
                                                                <ul class="list-wrapper pd-lr-10">
                                                                    <li> <a href="<?php echo base_url();?>/index.php?center_user/manage_profile"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Edit Profile</div> </a> </li>
    ...
    <nav class="">
        <div class="container-fluid">
            <ul class="nav navbar-nav">                               
                <li><a href="<?php echo base_url(); ?>index.php?center_user/exam">Registered Student List</a></li>       
                <li><a href="<?php echo base_url(); ?>index.php?center_user/attendance">Fill Attendance</a></li> 
                <li><a href="<?php echo base_url(); ?>index.php?center_user/attendance_list">Attendance List</a></li>   
            </ul>
        </div>
    </nav>
</header>
