...
<div class="main-section">
                ...
                <div class="section-fullwidtht col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="image-frame has-border">
                                <div class="cs-media">
                                    <figure><img src="<?php echo base_url(); ?>site_assets/extra-images/image-frame-img-1.jpg" alt="" /></figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="cs-team grid">
                                <div class="cs-media">
                                    <figure>
                                        <a href="#"><img src="<?php echo base_url(); ?>site_assets/extra-images/team1.jpg" alt="#"></a>
                                    </figure>
                                </div>
                                <div class="cs-text">
                                    ...
                                    <div class="cs-social-media">
                                        <ul>
                                            ...
                                            <li><a href="#" data-original-title="pinterest"><i class="icon-pinterest3"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="cs-team grid">
                                <div class="cs-media">
                                    <figure>
                                        <a href="#"><img src="<?php echo base_url(); ?>site_assets/extra-images/team2.jpg" alt="#"></a>
                                    </figure>
                                </div>
                                <div class="cs-text">
                                    <h5><a href="#" class="cs-color">Arthur Springs</a></h5>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="cs-team grid">
                                <div class="cs-media">
                                    <figure>
                                        <a href="#"><img src="<?php echo base_url(); ?>site_assets/extra-images/team3.jpg" alt="#"></a>
                                    </figure>
                                </div>
                                <div class="cs-text">
                                    <h5><a href="#" class="cs-color">Arthur Springs</a></h5>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="cs-team grid">
                                <div class="cs-media">
                                    <figure>
                                        <a href="#"><img src="<?php echo base_url(); ?>site_assets/extra-images/team4.jpg" alt="#"></a>
                                    </figure>
                                </div>
                                <div class="cs-text">
                                    <h5><a href="#" class="cs-color">Arthur Springs</a></h5>
    ...
    <div class="page-section">
        <div class="section-fullwidtht col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="row cs-testimonial">
                <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div class="cs-media">
                        <figure>
                            <img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-img-1.jpg" alt="" />
                            <figcaption>
                                <div class="cs-text">
                                    <p>“Diet and health, human osteology, paleopathology/ epidemiology, human evolution, disease ecology,</p>
                                    <div class="cs-media">
                                        <figure><img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-sm-img-1.jpg" alt="" /></figure>
                                    </div>
                                    <div class="cs-info">
                ...
                <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div class="cs-media">
                        <figure>
                            <img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-img-2.jpg" alt="" />
                            <figcaption>
                                <div class="cs-text">
                                    <p>“Diet and health, human osteology, paleopathology/ epidemiology, human evolution, disease ecology,</p>
                                    <div class="cs-media">
                ...
                <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div class="cs-media">
                        <figure>
                            <img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-img-3.jpg" alt="" />
                            <figcaption>
                                <div class="cs-text">
                                    <p>“Diet and health, human osteology, paleopathology/ epidemiology, human evolution, disease ecology,</p>
                                    <div class="cs-media">
                ...
                <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div class="cs-media">
                        <figure>
                            <img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-img-4.jpg" alt="" />
                            <figcaption>
                                <div class="cs-text">
                                    <p>“Diet and health, human osteology, paleopathology/ epidemiology, human evolution, disease ecology,</p>
                                    <div class="cs-media">
                ...
                <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div class="cs-media">
                        <figure>
                            <img src="<?php echo base_url(); ?>site_assets/extra-images/testimonial-img-5.jpg" alt="" />
                            <figcaption>
                                <div class="cs-text">
                                    <p>“Diet and health, human osteology, paleopathology/ epidemiology, human evolution, disease ecology,</p>
                                    <div class="cs-media">
