...
*/
		...
		// Being a 3 letter tag is non-standard, and does not allow it to be set by font-feature-system_setting
...
function _applyTagSettings($tags, $Features, $omittags='', $onlytags=false) {
		...
		// Font features to enable - set by font-feature-system_setting
		...
		// Font features to disable - set by font-feature-system_setting
...
function get_arab_glyphs($char, $type, &$chars, $i, $scriptTag, $usetags) {
	...
	// Optional Feature system_setting	// doesn't control Syriac at present
