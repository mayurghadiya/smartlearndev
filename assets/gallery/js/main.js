...
jQuery(".btndesign").on("click", function() {
                            if( $("video").prop('muted') )
                            {                 
                                document.getElementById("mutebtn2").value="";
                                $("video").prop('muted', false);                                
									$( "#overlay .btndesign i" ).addClass("fa-volume-up");
									$( "#overlay .btndesign i" ).removeClass("fa-volume-down");                                                                                         
                            }   
                            else 
                            {
                                document.getElementById("mutebtn2").value="";
                                $("video").prop('muted', true);                                
									$( "#overlay .btndesign i" ).addClass("fa-volume-down");
									$( "#overlay .btndesign i" ).removeClass("fa-volume-up");
                            }
...
------------------------------------------------------------------ */
	...
	$("#scrollUp").addClass('icon-arrow-up hvr-pulse-grow');
...
================================================================== */
    ...
    obt1 = new Vivus( 'obturateur1', { type: 'oneByOne', duration: 350 });
    obt2 = new Vivus( 'obturateur2', { type: 'oneByOne', duration: 400 });
    obt3 = new Vivus( 'obturateur3', { type: 'oneByOne', duration: 400 });

// jQuery(document).ready(function(){
// 		jQuery('instagram-wrap instagram-image').hover(			
// 		    function(){
// 		    	alert('hi');
