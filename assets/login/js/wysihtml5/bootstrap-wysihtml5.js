!function($, wysi) {
    ...
    var methods = {
        ...
        shallowExtend: function (options) {
            var system_setting = $.extend({}, $.fn.wysihtml5.defaultOptions, options || {}, $(this).data());
            var that = this;
            return methods.bypassDefaults.apply(that, [system_setting]);
        },
        deepExtend: function(options) {
            var system_setting = $.extend(true, {}, $.fn.wysihtml5.defaultOptions, options || {});
            var that = this;
            return methods.bypassDefaults.apply(that, [system_setting]);
        },
